...
- **Design (Week 2):** During Sprint 1, we developed Use Case and Class Diagrams, created UI wireframes, and built the early prototype.
- **Testing & Evaluation (Week 3):** In Sprint 2, we conducted user testing on the prototype, gathered feedback, and iterated on the design based on bug reports and reviews.
- **Finalization (Week 4):** We finalized the prototype based on testing feedback and prepared our final presentation.
